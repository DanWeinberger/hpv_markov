...
age_40 <- function(ulsil_uhsil_2_3,ulsil_uhsil_4,uhsil_ulsil_2_3,uhsil_ulsil_4){
...
Pop_size_4 = (154566548-Pop_size_0-Pop_size_1-Pop_size_2-Pop_size_3)*0.4
...
#uhsil_ulsil_2_3 <- 0.2 # undetected HSIL > undetected LSIL (25-39)
#uhsil_ulsil_4 <- 0.2
...
for(i in 2:t){
  ...
  arr1[i,1,5] <- (arr1[(i-1),1,5]) +  
    ...
    (arr1[(i-1),1,5])*p_die_4         # die (unrelated)
  # LSIL undetected 40+ (2)
  arr1[i,2,5] <- (arr1[(i-1),2,5]) + 
    (arr1[(i-1),2,4])*age_out +        # age up
    (arr1[(i-1),1,5])*norm_ulsil_4 +    # normal progress to undetected LSIL
    ...
    (arr1[(i-1),2,5])*p_die_4         # die (unrelated)
  # LSIL detected 40+ (3)
  arr1[i,3,5] <- (arr1[(i-1),3,5]) + 
    (arr1[(i-1),3,4])*age_out +        # age up
    (arr1[(i-1),1,5])*norm_dlsil_4 +    # normal progress to detected LSIL
    ...
    (arr1[(i-1),3,5])*p_die_4         # die (unrelated)
  # HSIL undetected 40+ (4) 
  arr1[i,4,5] <- (arr1[(i-1),4,5]) + 
    (arr1[(i-1),4,4])*age_out +        # age up
    (arr1[(i-1),2,5])*ulsil_uhsil_4 + # undetected LSIL progress to undetected HSIL 
    (arr1[(i-1),3,5])*dlsil_uhsil -     # detected LSIL LTFU to undetected HSIL
    (arr1[(i-1),4,5])*uhsil_ulsil_4 - # undetected HSIL regress to undetected LSIL
    ...
    (arr1[(i-1),4,5])*p_die_4         # die (unrelated)
  # HSIL detected 40+ (5)
  arr1[i,5,5] <- (arr1[(i-1),5,5]) + 
    (arr1[(i-1),5,4])*age_out +        # age up
    (arr1[(i-1),3,5])*dlsil_dhsil_4 + # detected LSIL progress to detected HSIL
    (arr1[(i-1),4,5])*uhsil_dhsil -     # undetected HSIL screened to detected HSIL
    (arr1[(i-1),5,5])*dhsil_dlsil_4 - # detected HSIL regress to detected LSIL
    ...
    (arr1[(i-1),5,5])*p_die_4         # die (unrelated)
  # Cancer undetected 40+ (6)
  arr1[i,6,5] <- (arr1[(i-1),6,5]) +
    (arr1[(i-1),6,4])*age_out +        # age up
...
Pop_size_4 = (154566548-Pop_size_0-Pop_size_1-Pop_size_2-Pop_size_3)*0.6
...
loglik <- sum(dpois(as.numeric(result_tot_noCov[which(result_tot_noCov$Year==2008),c(5,7,8)]), c(216000,11778,3663), log=TRUE))


output <- list("Results"=as.numeric(result_tot_noCov[which(result_tot_noCov$Year==2008),c(5,7,8)]), "LL"=loglik)
...
# Inputs
ulsil_uhsil_2_3_seq <- seq(0.25,0.40,0.05)
ulsil_uhsil_4_seq <- seq(0.25,0.40,0.05)
uhsil_ulsil_2_3_seq <- seq(0.25,0.40,0.05) 
uhsil_ulsil_4_seq <- seq(0.25,0.40,0.05)


# Empty vector for function output
LL <- array(NA, dim=c(length(ulsil_uhsil_2_3_seq),length(ulsil_uhsil_4_seq),length(uhsil_ulsil_2_3_seq),length(uhsil_ulsil_4_seq)))

Results <- array(NA, dim=c(3,length(ulsil_uhsil_2_3_seq),length(ulsil_uhsil_4_seq),length(uhsil_ulsil_2_3_seq),length(uhsil_ulsil_4_seq)))

# Run for loop
for(i in 1:length(ulsil_uhsil_2_3_seq)){
  for(j in 1:length(ulsil_uhsil_4_seq)){
    for(k in 1:length(uhsil_ulsil_2_3_seq)){
      for(l in 1:length(uhsil_ulsil_4_seq)){
          LL[i,j,k,l] <- age_40(ulsil_uhsil_2_3=ulsil_uhsil_2_3_seq[i],ulsil_uhsil_4=ulsil_uhsil_4_seq[j],uhsil_ulsil_2_3=uhsil_ulsil_2_3_seq[k],uhsil_ulsil_4=uhsil_ulsil_4_seq[l])$LL
          Results[,i,j,k,l] <- age_40(ulsil_uhsil_2_3=ulsil_uhsil_2_3_seq[i],ulsil_uhsil_4=ulsil_uhsil_4_seq[j],uhsil_ulsil_2_3=uhsil_ulsil_2_3_seq[k],uhsil_ulsil_4=uhsil_ulsil_4_seq[l])$Results
...
p_LSIL<-ggplot(data=result_tot, aes(x=Year)) +
  ...
  geom_line(data=result_tot, aes(y=Undet_LSIL), colour="red",linetype="dashed") + 
  geom_line(data=result_tot_noCov, aes(y=Det_LSIL), colour="red", alpha=0.5) +
  geom_line(data=result_tot, aes(y=Det_LSIL), colour="red") +
  geom_line(data=result_tot_noCov, aes(y=All_LSIL), colour="black", alpha=0.5) +
  geom_line(data=result_tot, aes(y=All_LSIL), colour="black") +
  coord_cartesian(
    xlim = c(2000,2050),
    ylim = c(0,1500000)) +
  geom_vline(xintercept = 2008,linetype="dashed",alpha=0.3) +
...
p_HSIL<-ggplot(data=result_tot, aes(x=Year)) +
  ...
  geom_line(data=result_tot, aes(y=Undet_HSIL), colour="red",linetype="dashed") + 
  geom_line(data=result_tot_noCov, aes(y=Det_HSIL), colour="red", alpha=0.5) +
  geom_line(data=result_tot, aes(y=Det_HSIL), colour="red") +
  geom_line(data=result_tot_noCov, aes(y=All_HSIL), colour="black", alpha=0.5) +
  geom_line(data=result_tot, aes(y=All_HSIL), colour="black") +
  coord_cartesian(
    xlim = c(2000,2050),
    ylim = c(0,500000)) +
  geom_vline(xintercept = 2008,linetype="dashed",alpha=0.3) +
...
p_Cancer<-ggplot(data=result_tot, aes(x=Year)) +
  ...
  geom_line(data=result_tot, aes(y=Undet_Cancer), colour="red",linetype="dashed") + 
  geom_line(data=result_tot_noCov, aes(y=Det_Cancer), colour="red", alpha=0.5) +
  geom_line(data=result_tot, aes(y=Det_Cancer), colour="red") +
  geom_line(data=result_tot_noCov, aes(y=Cancer_Death), colour="red", alpha=0.5) +
  geom_line(data=result_tot, aes(y=Cancer_Death), colour="red",linetype="dotted") +
  geom_line(data=result_tot_noCov, aes(y=All_Cancer), colour="black", alpha=0.5) +
  geom_line(data=result_tot, aes(y=All_Cancer), colour="black") +
  coord_cartesian(
    xlim = c(2000,2050),
    ylim = c(0,55000)) +
  geom_vline(xintercept = 2008,linetype="dashed",alpha=0.3) +
