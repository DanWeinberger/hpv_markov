...
# Plot results
plot(p_1_2_seq, LL[,1,1,1,1,1])
plot(p_2_1_seq, LL[1,,1,1,1,1])
plot(p_2_3_seq, LL[1,1,,1,1,1])
plot(p_3_2_seq, LL[1,1,1,,1,1])
plot(p_3_4_seq, LL[1,1,1,1,,1])
plot(p_4_5_seq, LL[1,1,1,1,1,])
